...
# ==================================================================================================
# class CartPoleEnvContrast(gym.Env[np.ndarray, Union[int, np.ndarray]]):
class CartPoleEnvContrast(gym.Env):
	"""
	### Description
	...
	**Note:** While the ranges above denote the possible values for observation space of each element, it is not reflective of the allowed values of the state space in an unterminated episode. Particularly:
	...
	def __init__(self):
		...
		# self.observation_space = spaces.Box(low=0, high=255, dtype=np.uint8, shape=(self.screen_height, self.screen_width, 1))
	...
	def step(self, action):
		...
		return np.array(self.render("rgb_array"), dtype=np.float32), reward, done, {}
