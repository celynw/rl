...
cmd="/code/venv/bin/python /code/train.py"
WANDB_API_KEY="local-10f17eeb44c533e126f6639891d16595a1c7f337"
WANDB_BASE_URL="http://umcvplws196:8080"

id=$(docker run -tid --runtime=nvidia -P -v ~/dev/python/rl/venv:/home/docker/venv -v ~/dev/python/rl:/code -v ~/dev/python/rl/catkin_ws:/catkin_ws -v ~/dev/python/rl/runs:/runs -e WANDB_API_KEY=$WANDB_API_KEY -e WANDB_BASE_URL=$WANDB_BASE_URL celynw/esim_rl:v4)
...
# docker exec -ti $id bash -ci "/code/venv/bin/python -m pip install -e /code"
